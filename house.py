...
with col2:
    bedroom = st.number_input("Bedrooms", min_value=1, max_value=10, value=3, step=1)

with col3:
    age = st.number_input("Age of House (years)", min_value=0, max_value=100, value=5, step=1)
